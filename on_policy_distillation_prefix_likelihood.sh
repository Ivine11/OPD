...
# configuration, and only enables prefix-likelihood weighting.

set -e

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

export TEACHER_CONF_WEIGHT_MODE=${TEACHER_CONF_WEIGHT_MODE:-"prefix_likelihood"}
export TEACHER_CONF_ALPHA=${TEACHER_CONF_ALPHA:-1.0}
